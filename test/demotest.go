...
// func main() {
// 	command := "java -cp /home/ubuntu/smb-code/smb-go1/code-sanbox/tmpcode/f687295d-b9ac-4e8f-94fd-ed10dbf2b143 Main"
...
// 			// 非零退出状态，可能是Java运行时错误
// 			fmt.Println("非零退出状态:", exitErr.ExitCode())
// 		}

// 		// 输出可能包含的错误信息
// 		fmt.Println("错误输出:", outputStr)
// 		// 根据输出内容进一步判断错误类型
// 		if strings.Contains(outputStr, "ClassNotFoundException") {
// 			fmt.Println("错误类型: Java类找不到错误")
// 		} else if strings.Contains(outputStr, "could not find or load main class") {
// 			fmt.Println("错误类型: 主类加载失败")
// 		}
// 		return
// 	}
